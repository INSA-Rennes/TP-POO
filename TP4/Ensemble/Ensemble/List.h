...
template <class T> class List {
	...
	public:
		...
		// =====================================================================
		virtual void addElement(const T& v, eListPosition pos = LP_first) {
			ListElement<T>* toadd;
			switch (pos) {
		...
		// =====================================================================
		// But: ajout d'une liste à une autre liste (par défaut en tête de liste)
		// =====================================================================
		void addAllElements(const List<T>& list, eListPosition pos = LP_first) {
			ListIterator<T> it = list.beg();
			while(!it.finished()) {
				this->addElement(it.get(), pos);
				it++;
			}
		}
		...
		// =====================================================================
		// But: suppression d'un élément (le premier trouve uniquement)
		// =====================================================================
		...
		// =====================================================================
		// But: supprime tous les elements d'une liste à la liste courante.
		// =====================================================================
		void delAllElements(const List<T>& list) {
			ListIterator<T> it = list.beg();
			while(!it.finished()) {
				this->delElement(it.get());
				it++;
			}
		}
...
template <class T> class ListIterator {
		...
		ListIterator(const List<T>& lref): _listref(lref) {
			_crtelt = lref._head->_next;
		}
	...
	public:
		...
		int finished() const {
			return _crtelt==_listref._tail || _crtelt==_listref._head;
		}
		// Parcours en marche avant
		ListIterator<T>& operator++() {
			_crtelt = _crtelt->_next; return *this;
		}
		// Parcours en marche arrière
		ListIterator<T>& operator--() {
			_crtelt = _crtelt->_prev; return *this;
		}
		// Récupération de l'élément courant
		T& get() {
			return _crtelt->_value;
		}
